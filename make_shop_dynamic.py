...
# Replace hardcoded product cards with dynamic generation script
product_grid_pattern = r'<div class="product-grid" id="productGrid">.*?</div>\s*</div>\s*<!-- SHOP MAIN CONTENT END -->'

new_grid_html = """<div class="product-grid" id="productGrid">
...
html = re.sub(product_grid_pattern, new_grid_html, html, flags=re.DOTALL)

# Add the script to generate shop products
shop_script = """
    <script type="module">
            ...
            if (productGrid) {
                productsData.forEach(p => {
                    ...
                    card.innerHTML = 
                        ...
                        <a href="product-details.html?id=" style="text-decoration:none; color:inherit; display:block;">
...
html = html.replace('</body>', shop_script)
